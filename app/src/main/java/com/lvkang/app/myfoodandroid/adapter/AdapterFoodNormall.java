 ...
 * 
 */
public class AdapterFoodNormall extends BaseAdapter {
	...
	public AdapterFoodNormall(Context c,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView != null) {
			...
			holder.foodIntroTextView=(TextView) convertView.findViewById(valueViewId[9]);
			holder.praise=(TextView) convertView.findViewById(valueViewId[10]);
		...
		if (appInfo != null) {
			...
			holder.foodIntroTextView.setText(appInfo.get(keystring[6]).toString());
			holder.praise.setText(appInfo.get(keystring[7]).toString());
	...
	class lvButtonListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			AdapterFoodNormall.this.notifyDataSetChanged();
