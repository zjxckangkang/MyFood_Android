package com.lvkang.app.myfoodandroid.image;
...
public class AsyncImageLoader {
	 ...
	 * @param imageUrl
	 */
	public Bitmap loadImage(ImageView imageView, String imageUrl,ProgressBar progressBar) {
		// 先从内存中拿
		...
		if (!TextUtils.isEmpty(imageUrl)) {
			new ImageDownloadTask(imageView,progressBar).execute(imageUrl);
		}
